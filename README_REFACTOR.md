...
5. Keep your existing `static/css/style.css` and all files in `static/img/`.
...
- Rebuilt `static/js/app.js` as isolated initializers for theme, search, nav dropdown, calendar, easy split, mode switch, and ai-erp receipt matcher.
